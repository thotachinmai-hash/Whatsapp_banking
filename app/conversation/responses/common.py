...
WORKFLOW_STEP_HINTS = {
    ...
    ("loan", "UPLOAD_LOAN_FORM"): "Please answer the next application question.",
    ...
    ("onboarding", "COLLECT_AADHAAR"): "We're still waiting on your Aadhaar card — please upload a clear image of it (your PAN card works too, if you'd rather send that first).",
    ("onboarding", "COLLECT_PAN"): "We're still waiting on your PAN card — please upload a clear image of it (your Aadhaar card works too, if you'd rather send that first).",
    ...
    ("add_account", "COLLECT_AADHAAR"): "We're still waiting on your Aadhaar card — please upload a clear image of it (your PAN card works too, if you'd rather send that first).",
    ("add_account", "COLLECT_PAN"): "We're still waiting on your PAN card — please upload a clear image of it (your Aadhaar card works too, if you'd rather send that first).",
